...
/obj/item/necra_censer
	...
	icon = 'modular_ratwood/icons/roguetown/items/misc.dmi'
	icon_state ="necra_censer"
	lefthand_file = 'modular_ratwood/icons/roguetown/mob/inhands/items_lefthand.dmi'
	righthand_file = 'modular_ratwood/icons/roguetown/mob/inhands/items_righthand.dmi'
