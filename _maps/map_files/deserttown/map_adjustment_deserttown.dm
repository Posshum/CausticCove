...
/datum/map_adjustment/template/deserttown
	...
	realm_name = "Al-Ashur"
	slot_adjust = list(
		/datum/job/roguetown/mercenary = 6, //Very important individuals in this barren land.
		/datum/job/roguetown/gnoll = 6, //Hyenas just belong here! Get us packs of gnolls!
	)
	title_adjust = list(
		...
		// /datum/job/roguetown/captain = list(display_title = "Cataphract Captain"), //We no longer have a captain.
